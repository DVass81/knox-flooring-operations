  ...
  return <>
    ...
    <Dialog open={centerOpen} onOpenChange={(next) => { setCenterOpen(next); if (!next) lastFocusRef.current?.focus(); }}>
      <DialogContent className="max-h-[88vh] max-w-4xl overflow-y-auto">
        ...
        <p className="text-xs leading-5 text-muted-foreground">Training narration is generated by AI. Practice activity is isolated from accounting, calendar sync, and external communications.</p>
      </DialogContent>
    </Dialog>
