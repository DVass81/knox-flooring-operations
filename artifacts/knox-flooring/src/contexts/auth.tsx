...
type AuthContextValue = { user: User | null; loading: boolean; login(email: string, password: string): Promise<void>; logout(): Promise<void>; forgot(email: string): Promise<string>; reset(token: string, password: string): Promise<void> };
